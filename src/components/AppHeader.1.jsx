...
export function AppHeader() {
    ...
    return (
        <header className="app-header full main container">
            ...
            <div
                className={`app-header full main container ${
                    isSticky ? "main-header flex sticky" : "main-header flex"
                }`}
            >
                <div
                    id="hamburger"
                ...
                <nav
                    className={`center ${isHeaderOpen ? "open" : ""}`}
                ...
                <nav
                    onClick={handleClickHeader}
                    className={`side-nav ${isHeaderOpen ? "open" : ""}`}
                >
